...
Requires: pupmod-puppet-kmod >= 5.0.0, pupmod-puppet-kmod < 6.0.0
Requires: pupmod-puppet-systemd >= 9.4.0, pupmod-puppet-systemd < 10.0.0
# renamed from pupmod-herculesteam-augeasproviders_core (ownership moved)
Requires: pupmod-puppet-augeasproviders_core >= 5.0.0, pupmod-puppet-augeasproviders_core < 6.0.0
# renamed from pupmod-herculesteam-augeasproviders_grub (ownership moved)
Requires: pupmod-puppet-augeasproviders_grub >= 6.0.0, pupmod-puppet-augeasproviders_grub < 7.0.0
# renamed from pupmod-herculesteam-augeasproviders_ssh (ownership moved)
Requires: pupmod-puppet-augeasproviders_ssh >= 7.0.0, pupmod-puppet-augeasproviders_ssh < 8.0.0
# renamed from pupmod-herculesteam-augeasproviders_sysctl (ownership moved)
Requires: pupmod-puppet-augeasproviders_sysctl >= 4.1.0, pupmod-puppet-augeasproviders_sysctl < 5.0.0
# renamed from pupmod-onyxpoint-gpasswd (ownership moved)
Requires: pupmod-simp-gpasswd >= 2.0.0, pupmod-simp-gpasswd < 3.0.0
Requires: pupmod-puppet-chrony >= 5.0.0, pupmod-puppet-chrony < 6.0.0
Requires: pupmod-puppet-firewalld >= 5.1.0, pupmod-puppet-firewalld < 6.0.0
Requires: pupmod-puppet-yum >= 8.0.0, pupmod-puppet-yum < 9.0.0
Requires: pupmod-puppetlabs-apache >= 13.1.0, pupmod-puppetlabs-apache < 14.0.0
Requires: pupmod-puppetlabs-concat >= 10.0.0, pupmod-puppetlabs-concat < 11.0.0
Requires: pupmod-puppetlabs-hocon >= 2.0.0, pupmod-puppetlabs-hocon < 3.0.0
Requires: pupmod-puppetlabs-inifile >= 6.4.0, pupmod-puppetlabs-inifile < 7.0.0
Requires: pupmod-puppetlabs-motd >= 7.3.0, pupmod-puppetlabs-motd < 8.0.0
Requires: pupmod-puppetlabs-postgresql >= 10.6.1, pupmod-puppetlabs-postgresql < 11.0.0
Requires: pupmod-puppetlabs-puppet_authorization >= 1.0.0, pupmod-puppetlabs-puppet_authorization < 2.0.0
Requires: pupmod-puppetlabs-puppetdb >= 8.1.0, pupmod-puppetlabs-puppetdb < 9.0.0
Requires: pupmod-puppetlabs-stdlib >= 10.0.0, pupmod-puppetlabs-stdlib < 11.0.0
Requires: pupmod-saz-timezone >= 7.0.0, pupmod-saz-timezone < 8.0.0
Requires: pupmod-simp-acpid >= 2.0.2, pupmod-simp-acpid < 3.0.0
Requires: pupmod-simp-aide >= 9.0.2, pupmod-simp-aide < 10.0.0
Requires: pupmod-simp-at >= 2.0.1, pupmod-simp-at < 3.0.0
Requires: pupmod-simp-auditd >= 10.1.2, pupmod-simp-auditd < 11.0.0
Requires: pupmod-simp-clamav >= 7.0.2, pupmod-simp-clamav < 8.0.0
Requires: pupmod-simp-compliance_markup >= 4.0.1, pupmod-simp-compliance_markup < 5.0.0
Requires: pupmod-simp-cron >= 2.0.1, pupmod-simp-cron < 3.0.0
Requires: pupmod-simp-crypto_policy >= 3.0.1, pupmod-simp-crypto_policy < 4.0.0
Requires: pupmod-simp-deferred_resources >= 1.0.2, pupmod-simp-deferred_resources < 2.0.0
Requires: pupmod-simp-dhcp >= 8.0.2, pupmod-simp-dhcp < 9.0.0
Requires: pupmod-simp-ds389 >= 2.0.1, pupmod-simp-ds389 < 3.0.0
Requires: pupmod-simp-fips >= 2.0.2, pupmod-simp-fips < 3.0.0
Requires: pupmod-simp-haveged >= 0.15.0, pupmod-simp-haveged < 1.0.0
Requires: pupmod-simp-iptables >= 8.0.4, pupmod-simp-iptables < 9.0.0
Requires: pupmod-simp-issue >= 1.0.1, pupmod-simp-issue < 2.0.0
Requires: pupmod-simp-logrotate >= 7.0.2, pupmod-simp-logrotate < 8.0.0
Requires: pupmod-simp-named >= 7.0.2, pupmod-simp-named < 8.0.0
# REMOVED for EL9 -- no such package in this release: Requires: pupmod-simp-ntpd >= 6.7.0, pupmod-simp-ntpd < 7.0.0
Requires: pupmod-simp-oddjob >= 3.0.2, pupmod-simp-oddjob < 4.0.0
Requires: pupmod-simp-pam >= 9.2.0, pupmod-simp-pam < 10.0.0
Requires: pupmod-simp-pki >= 7.0.2, pupmod-simp-pki < 8.0.0
Requires: pupmod-simp-polkit >= 7.0.2, pupmod-simp-polkit < 8.0.0
Requires: pupmod-simp-postfix >= 7.0.2, pupmod-simp-postfix < 8.0.0
Requires: pupmod-simp-pupmod >= 12.3.0, pupmod-simp-pupmod < 13.0.0
Requires: pupmod-simp-resolv >= 1.0.2, pupmod-simp-resolv < 2.0.0
Requires: pupmod-simp-rsync >= 8.0.1, pupmod-simp-rsync < 9.0.0
Requires: pupmod-simp-rsyslog >= 9.2.0, pupmod-simp-rsyslog < 10.0.0
Requires: pupmod-simp-selinux >= 4.0.1, pupmod-simp-selinux < 5.0.0
Requires: pupmod-simp-simp >= 9.0.1, pupmod-simp-simp < 10.0.0
Requires: pupmod-simp-simp_apache >= 9.0.2, pupmod-simp-simp_apache < 10.0.0
Requires: pupmod-simp-simp_banners >= 1.0.1, pupmod-simp-simp_banners < 2.0.0
Requires: pupmod-simp-simp_ds389 >= 2.0.1, pupmod-simp-simp_ds389 < 3.0.0
Requires: pupmod-simp-simp_firewalld >= 2.0.3, pupmod-simp-simp_firewalld < 3.0.0
Requires: pupmod-simp-simp_options >= 3.0.1, pupmod-simp-simp_options < 4.0.0
Requires: pupmod-simp-simp_rsyslog >= 1.0.1, pupmod-simp-simp_rsyslog < 2.0.0
Requires: pupmod-simp-simpkv >= 1.0.1, pupmod-simp-simpkv < 2.0.0
Requires: pupmod-simp-simplib >= 7.0.1, pupmod-simp-simplib < 8.0.0
Requires: pupmod-simp-ssh >= 9.1.0, pupmod-simp-ssh < 10.0.0
Requires: pupmod-simp-sssd >= 10.1.2, pupmod-simp-sssd < 11.0.0
Requires: pupmod-simp-stunnel >= 9.0.2, pupmod-simp-stunnel < 10.0.0
Requires: pupmod-simp-sudo >= 7.0.0, pupmod-simp-sudo < 8.0.0
Requires: pupmod-simp-svckill >= 5.1.1, pupmod-simp-svckill < 6.0.0
Requires: pupmod-simp-swap >= 1.0.2, pupmod-simp-swap < 2.0.0
Requires: pupmod-simp-tftpboot >= 8.0.1, pupmod-simp-tftpboot < 9.0.0
Requires: pupmod-simp-tlog >= 1.0.1, pupmod-simp-tlog < 2.0.0
Requires: pupmod-simp-useradd >= 3.1.2, pupmod-simp-useradd < 4.0.0
Requires: pupmod-simp-vox_selinux >= 6.0.0, pupmod-simp-vox_selinux < 7.0.0
...
Requires: simp-adapter >= 2.1.1, simp-adapter < 3.0.0
Requires: pupmod-puppet-gitlab >= 11.0.0, pupmod-puppet-gitlab < 12.0.0
Requires: pupmod-puppet-posix_acl >= 3.1.0, pupmod-puppet-posix_acl < 4.0.0
Requires: pupmod-puppet-snmp >= 7.3.0, pupmod-puppet-snmp < 8.0.0
Requires: pupmod-puppetlabs-java >= 11.2.0, pupmod-puppetlabs-java < 12.0.0
Requires: pupmod-puppetlabs-ruby_task_helper >= 1.0.0, pupmod-puppetlabs-ruby_task_helper < 2.0.0
Requires: pupmod-puppetlabs-translate >= 2.2.0, pupmod-puppetlabs-translate < 3.0.0
Requires: pupmod-saz-locales >= 5.0.0, pupmod-saz-locales < 6.0.0
Requires: pupmod-treydock-kdump >= 2.0.4, pupmod-treydock-kdump < 3.0.0
Requires: pupmod-simp-autofs >= 8.0.1, pupmod-simp-autofs < 9.0.0
Requires: pupmod-simp-dconf >= 2.0.1, pupmod-simp-dconf < 3.0.0
Requires: pupmod-simp-freeradius >= 9.0.2, pupmod-simp-freeradius < 10.0.0
Requires: pupmod-simp-gdm >= 8.1.2, pupmod-simp-gdm < 9.0.0
Requires: pupmod-simp-gnome >= 10.0.2, pupmod-simp-gnome < 11.0.0
Requires: pupmod-simp-ima >= 1.0.3, pupmod-simp-ima < 2.0.0
Requires: pupmod-simp-krb5 >= 8.0.2, pupmod-simp-krb5 < 9.0.0
Requires: pupmod-simp-libreswan >= 5.0.0, pupmod-simp-libreswan < 6.0.0
Requires: pupmod-simp-libvirt >= 6.0.2, pupmod-simp-libvirt < 7.0.0
Requires: pupmod-simp-mate >= 2.0.1, pupmod-simp-mate < 3.0.0
Requires: pupmod-simp-mozilla >= 6.0.1, pupmod-simp-mozilla < 7.0.0
Requires: pupmod-simp-nfs >= 8.0.1, pupmod-simp-nfs < 9.0.0
Requires: pupmod-simp-oath >= 1.0.2, pupmod-simp-oath < 2.0.0
Requires: pupmod-simp-openscap >= 7.0.2, pupmod-simp-openscap < 8.0.0
Requires: pupmod-simp-simp_gitlab >= 1.0.1, pupmod-simp-simp_gitlab < 2.0.0
Requires: pupmod-simp-simp_grub >= 2.0.1, pupmod-simp-simp_grub < 3.0.0
Requires: pupmod-simp-simp_nfs >= 2.0.1, pupmod-simp-simp_nfs < 3.0.0
Requires: pupmod-simp-simp_snmpd >= 2.0.1, pupmod-simp-simp_snmpd < 3.0.0
Requires: pupmod-simp-tpm2 >= 1.0.2, pupmod-simp-tpm2 < 2.0.0
Requires: pupmod-simp-tuned >= 1.0.2, pupmod-simp-tuned < 2.0.0
Requires: pupmod-simp-vnc >= 8.0.2, pupmod-simp-vnc < 9.0.0
Requires: pupmod-simp-vsftpd >= 9.0.2, pupmod-simp-vsftpd < 10.0.0
Requires: pupmod-simp-x2go >= 1.0.2, pupmod-simp-x2go < 2.0.0
